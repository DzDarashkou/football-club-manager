...
import { CloudSun, CloudRain, Snowflake, Sun, Thermometer } from 'lucide-vue-next'
...
<template>
  <Card :class="`overflow-hidden border ${presentation.class}`">
    ...
    <p class="mt-3 text-sm opacity-75">Przewidywane opady: {{ weather.precipitationMm }} mm<span v-if="weather.snowfallMm > 0"> · śnieg: {{ weather.snowfallMm }} cm</span></p>
