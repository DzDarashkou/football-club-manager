...
const form = reactive<AdminPlayerInput>({ full_name: '', date_of_birth: '', team_id: '', is_active: true })
...
function resetForm() { selectedPlayerId.value = null; form.full_name = ''; form.date_of_birth = ''; form.team_id = activeTeams.value[0]?.id ?? ''; form.is_active = true; pageError.value = null }
function editPlayer(player: AdminPlayer) { selectedPlayerId.value = player.id; form.full_name = player.full_name; form.date_of_birth = player.date_of_birth; form.team_id = player.team_id; form.is_active = player.is_active; pageError.value = null }
