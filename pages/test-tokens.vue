...
<template>
  <div class="mx-auto max-w-5xl space-y-8">
    <section class="space-y-3">
      <div>
        <p class="eyebrow text-brand-700">System projektowy</p>
    ...
    <section class="space-y-3">
      <h2>Przyciski</h2>
      <div class="flex flex-wrap gap-3">
        <Button>Główna akcja</Button>
        <Button variant="outline">Akcja obrysowana</Button>
        <Button variant="secondary">Akcja drugorzędna</Button>
      </div>
    </section>
  </div>
</template>
