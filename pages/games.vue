...
<template>
  <div v-if="role === 'admin' || role === 'coach'" class="mx-auto max-w-3xl space-y-4"><h1>Games</h1><p class="text-body text-[color:var(--color-text-secondary)]">Use the coach workflow to select players and manage attendance.</p><Button as="NuxtLink" to="/coach/games">Open coach games</Button></div>
